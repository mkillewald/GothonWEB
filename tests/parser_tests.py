...
def test_peek():
    ...
    w = parser.Parser(word_list)
    result = w._Parser__peek()
    assert_equal(result, 'verb')

def test_match():
    word_list = [('verb', 'open'), ('stop', 'the'), ('noun', 'door')]
    w = parser.Parser(word_list)
    result = w._Parser__match('verb')
...
def test_parse_object():
    word_list = [('stop', 'the'), ('noun', 'door')]
    w = parser.Parser(word_list)
    result = w._Parser__parse_object()
...
def test_parse_subject():
    word_list = [('verb', 'open'), ('stop', 'the'), ('noun', 'door')]
    w = parser.Parser(word_list)
    result = w._Parser__parse_subject(('noun', 'user'))
...
def test_parse_number():
    ...
    w = parser.Parser(word_list)
    result = w._Parser__parse_number(('noun', 'user'), ('verb', 'typed'))
    assert_equal(result.subject, 'user')
